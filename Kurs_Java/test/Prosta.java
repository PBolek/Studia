...
class Prosta{
    ...
    static Punkt punkt_przeciecia_prostych(Prosta p1, Prosta p2){
        if(czy_prostopadle(p1, p2) == true)
            throw InvalidArgumentException("czy_prostopadle(p1, p2) == true");
        Punkt wynik = Punkt();
        double wx, wy, w;
    ...
    public static void przesun(Wektor v){
