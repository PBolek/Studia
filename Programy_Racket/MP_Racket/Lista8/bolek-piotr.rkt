...
(define (test1)
        (= (eval (list ari-eval (list (quote +) 10 -10))) (+ 10 -10)))

(define (test2)
  (= (eval (list ari-eval (list (quote /) 10 10))) (/ 10 10)))

(define (test3)
  (= (eval (list ari-eval (list (quote *) 2 10))) (* 2 10)))

(define (test4)
  (= (eval (list ari-eval (list (quote -) 10 5))) (- 10 5)))

(define (test5)
  (= (eval (list ari-eval (list (quote +) (list (quote -) 10 10) (list (quote *) 2 5))))
       (+ (- 10 10) (* 2 5))))

(define (test6)
  (= (eval (list ari-eval (list (quote +)
                                  (list (quote -)
                                        (list (quote *) 2 5)
                                        (list (quote *) 2 5))
                                  (list (quote +)
...
(define (test)
(and (test1) (test2) (test3) (test4) (test5) (test6)))
